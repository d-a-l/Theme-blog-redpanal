...
function attitude_footer_info() {         
   $output = '<div class="copyright">'.'<a rel="license" href="http://creativecommons.org/licenses/by/3.0/deed.es"><img alt="Licencia Creative Commons" style="border-width:0" src="http://i.creativecommons.org/l/by/3.0/88x31.png" /></a>'.' '.' - [site-link]'.' - '.__( 'Theme by:', 'attitude' ).' '.'[th-link]'.' - '.__( 'Powered by:', 'attitude' ).' '.'[wp-link] '.'</div><!-- .copyright -->';
